...
public:
    ...
    double Inrun(double x) const;
    double LandingArea(double x) const;
    std::vector<osj::vec2> GenerateLandingAreaPoints(int accuracy = 1000) const;
    std::vector<osj::vec2> GenerateInrunPoints() const;
    osj::vec2 GatePoint(int nr);
};
